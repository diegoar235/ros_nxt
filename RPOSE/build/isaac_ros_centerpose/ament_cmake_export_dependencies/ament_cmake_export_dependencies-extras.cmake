...
set(_exported_dependencies "cv_bridge;isaac_ros_nitros;isaac_ros_nitros_detection3_d_array_type;isaac_ros_nitros_tensor_list_type;isaac_ros_nitros_image_type;isaac_ros_nitros_camera_info_type;isaac_ros_dnn_image_encoder;isaac_ros_tensor_list_interfaces;isaac_ros_tensor_rt;isaac_ros_triton;message_filters;rclcpp;sensor_msgs;tf2_eigen")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to isaac_ros_centerpose_DEFINITIONS, isaac_ros_centerpose_INCLUDE_DIRS,
# isaac_ros_centerpose_LIBRARIES, and isaac_ros_centerpose_LINK_FLAGS.
# Additionally collect the direct dependency names in
# isaac_ros_centerpose_DEPENDENCIES as well as the recursive dependency names
# in isaac_ros_centerpose_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(isaac_ros_centerpose_DEPENDENCIES ${_exported_dependencies})
  set(isaac_ros_centerpose_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(isaac_ros_centerpose_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(isaac_ros_centerpose_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(isaac_ros_centerpose_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(isaac_ros_centerpose_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(isaac_ros_centerpose_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND isaac_ros_centerpose_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
